...
public class MOLog
{
	...
	public MOLog(DBConfig mConfigObj) throws Exception
	{
		try
		{
	 ...
	 * <p>Type = 1: lấy thông tin chi tiết 1 record Para_1 = MOLogID</p>
	 * @param Para_1
	 * @return
	 * @throws Exception
	 * @throws SQLException
	...
	public MyTableModel Select(int Type, String Para_1) throws Exception, SQLException
	{
		try
		{
			...
			return mGet.GetData_Pro("Sp_MOLog_Select", Arr_Name, Arr_Value);
		}
	...
	public boolean Insert(int Type, String XMLContent) throws Exception,SQLException
	{
		try
		{
			...
			return mExec.Execute_Pro("Sp_MOLog_Insert", Arr_Name, Arr_Value);
		}
		catch(SQLException ex)
		{
			throw ex;
