...
public class Subscriber
{
	...
	public enum Status
	{
		...
		ChargeFail(3),
		/**
		 * Cho biết khách hàng đã được Hủy Thuê bao (gọi từ API)
		 */
		UndoSub(4),

		/**
		 * Cho biết khách hàng đang dùng thử: Tình trạng này có khi VNP gọi đăng
		 * ký từ API
		 */
		Trial(5), /**
	...
	/**
	 * Cho biết thuê báo có cần gửi MT nhắc nhở hay không
	 * 
	...
	public enum RemiderType
	{
		NoThing(0),
		/**
		 * Nếu thuê bao đang trong tình trạng dùng thử thì lần gần hết hạn dùng
		 * thử sẽ gửi MT thông báo
		 */
		Trial(1), ;

		private int value;

		private RemiderType(int value)
		{
			this.value = value;
		}
		...
		public static RemiderType FromInt(int iValue)
		{
			for (RemiderType type : RemiderType.values())
			{
				if (type.GetValue() == iValue)
					return type;
			}
	 ...
	 * @param Type
	 *            <p>
	 *            Type = 9: Lấy tất cả dịch vụ 1 số điện thoại (Para_1 =
	 *            PID, Para_2 = MSISDN)
	 *            </p>
	 * @param Para_1
	 * @param Para_2
	 ...
	 * @param Type
	 *            <p>
	 *            Type = 10: Lấy tất cả dịch vụ 1 số điện thoại trong 1
	 *            khoảng thời gian (Para_1 = PID, Para_2 = MSISDN,Para_3 =
	 *            ServiceID, Para_4 = BeginDate, Para_5 = EndDate)
	 *            </p>
	 * @param Para_1
	 * @param Para_2
	 * @param Para_3
	 ...
	 * @param Type
	 *            <p>
	 *            Type = 8:Lấy danh sách(Para_1 = RowCount, Para_2 = PID, Para_3
	 *            = ServiceID, Para_4 = OrderID, Para_5 = ProcessNumber, Para_6
	 *            = ProcessIndex
	 *            </p>
	 * @param Para_1
	 * @param Para_2
	 ...
	 * @throws SQLException
	 */
	public MyTableModel Select(int Type, String Para_1, String Para_2, String Para_3, String Para_4, String Para_5, String Para_6, String Para_7)
	 ...
	 *            </p>
	 *            <p>
	 *            Type = 1: Update thông tin PUsh MT
	 *            </p>
	 * @param XMLContent
	 * @return
	 * @throws Exception
